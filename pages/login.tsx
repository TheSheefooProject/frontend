...
const Login: NextPage = () => {
  return (
    <main className="static flex min-h-screen w-[100%] min-w-[320px] flex-col justify-between overflow-x-hidden bg-back_3 px-10 pt-12 text-text_1  md:px-[calc(25vw+5rem)]">
      {/* Profile Container */}
      <div className="flex flex-col justify-between self-center font-body md:flex-row">
        <div id="loginlogo" className="mr-10 h-48 w-48 overflow-hidden">
          <Image src="/logo.svg" width={500} height={500}></Image>
        </div>
        <div className="self-center rounded border-0 bg-back_1 p-6">
          <ul>
            <li className="flex w-96 flex-col gap-1">
